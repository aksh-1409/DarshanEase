...
const CreateTemple = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.templeImage) {
      toast.error('Please upload a temple image');
      return;
    }
    ...
    try {
      ...
      await organizerService.createTemple(data);
  ...
  return (
    <OrganizerLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Register New Temple</h1>
          <p className="text-gray-600">Add a new temple to your management</p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Temple Image <span className="text-red-500">*</span>
              </label>
              <div className="relative">
                {imagePreview ? (
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-primary transition-colors bg-gray-50">
                    ...
                    <p className="text-sm text-gray-600 mb-2">Click to upload temple image</p>
